...
from gptube import generate_answer, generate_summary, is_valid_openai_key, is_valid_youtube_url, get_video_duration, calculate_api_cost
...
def gptube_app():
    ...
    choice = st.radio("Please choose an option before inputing any information :", ('Generate Summary', 'Generate Answer to a Question'), horizontal=True)
