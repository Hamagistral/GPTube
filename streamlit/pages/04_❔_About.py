...
st.markdown("- **OpenAI's Whisper API** for audio processing.  ")
...
st.markdown("- Automatic summarization of audio content.  ")
st.markdown("- Text-to-speech conversion for creating audio summaries.  ")
st.markdown("- Integration with LangChain for text-based interactions.  ")
